<aura:application extends="force:slds" controller="DataTableDemoAppController">
    ...
    <c:DataTableCmp aura:id="dataTable">
        <aura:set attribute="columns">
            <c:DataTableColumnCmp label="Contact ID" name="Id" linkToRecord="Id" sortable="true" />

            <c:DataTableColumnCmp label="Contact Name" name="Name" linkToRecord="Id" sortable="true" />

            <c:DataTableColumnCmp label="First Name" name="FirstName" linkToRecord="Id" sortable="true" />

            <c:DataTableColumnCmp label="Last Name" name="LastName" linkToRecord="Id" sortable="true" />

            <c:DataTableColumnCmp label="Account Name" name="Account.Name" linkToRecord="Account.Id" sortable="true" />
        </aura:set>
